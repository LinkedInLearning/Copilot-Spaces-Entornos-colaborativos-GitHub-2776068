# Copilot Spaces: Entornos colaborativos en GitHub
...
3. Instala las dependencias de sistema con el comando 
`npm install`
4. Ejecuta la aplicación en un servidor local con el comando
`npm run dev`
5. Utiliza la carpeta `__Prompts_del_curso` para copiar localmente los prompts utilizados.
